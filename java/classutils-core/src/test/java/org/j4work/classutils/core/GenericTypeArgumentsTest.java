...
/**
 * Unit tests for the {@link GenericTypes#getActualTypeArguments(Class, Class)} method.
 *
 * @author aphillips
 * @since 6 Mar 2009
 */
@RunWith(value = Parameterized.class)
public class GenericTypeArgumentsTest {
    ...
    private interface TypedInterface<N, O> {

    }

    private interface TypedSubinterface<P> extends TypedInterface<P, Short> {
    ...
    private interface TypedSubinterface2 extends TypedSubinterface<Byte> {
    ...
    public static Collection<Object[]> data() {
        ...
        // invalid arguments
        data.add(
            new Object[]{new TypedClass<Integer, Short, Byte>().getClass(), null, false, null});
    ...
    public GenericTypeArgumentsTest(
        Class<?> typedClass, Class<?> typedSuperclass,
    ...
    public void getActualTypeArguments_invalid() {
        ...
        if (!validArguments) {
            ...
            try {
                ...
                GenericTypes.getActualTypeArguments(typedClass, (Class) typedSuperclass);
                fail();
